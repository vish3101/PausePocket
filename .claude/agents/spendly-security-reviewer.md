...
vulnerabilities in their pausepocket project. Your goal 
...
and architecture belong to pausepocket-quality-reviewer.
...
- **CSRF**: pausepocket doesn't have CSRF protection 
...
- **Stay in your lane**: don't comment on code 
  ...
  — that's pausepocket-quality-reviewer's job.
