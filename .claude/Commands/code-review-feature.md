...
description: Runs parallel security and quality code 
  review for a specific pausepocket feature. Pass the spec 
...
**pausepocket-security-reviewer** receives:
...
**pausepocket-quality-reviewer** receives:
- The combined diff from the pre-flight check
- Spec file for context: `.claude/specs/$ARGUMENTS.md`
...
Security Findings
[pausepocket-security-reviewer output]
Quality Findings
[pausepocket-quality-reviewer output]
