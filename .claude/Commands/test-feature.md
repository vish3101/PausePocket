---
description: Writes and runs tests for a specific pause pocket feature. Pass the spec name as argument e.g. /test-feature 05-backend-connection
...
<spec-name> e.g. /test-feature 05-expense-list"
...
Invoke the **pausepocket-test-writer** subagent with the 
following context:
...
Wait for pausepocket-test-writer to fully complete and 
...
Once pausepocket-test-writer has finished, invoke the 
**pausepocket-test-runner** subagent with the following 
context:
...
- If pausepocket-test-writer reports it could not write 
...
**Step 2 — Test Results**
- Mirror the pausepocket-test-runner's structured report
